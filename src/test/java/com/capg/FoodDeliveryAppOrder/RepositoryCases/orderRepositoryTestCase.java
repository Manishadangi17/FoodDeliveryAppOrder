package com.capg.FoodDeliveryAppOrder.RepositoryCases;
...
@SpringBootTest
public class orderRepositoryTestCase {
	@Autowired
	private OrderRepository orderRepository;
	 ...
	 @BeforeEach
	 public void OrderRepositoryTestCaseSetup() {
		 order = new Order (6, 368.3,1);
	 ...
	 public void placeOrderTest() {
		 Mockito.when(orderRepositoryy.save(order)).thenReturn(order);
//		 assertThat(orderRepositoryy.getById(OrderId)).isEqualTo(order);
...
//		 orderRepositoryy.deleteOrder(order.getOrderId());
